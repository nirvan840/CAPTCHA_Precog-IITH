...
# Paths
ROOT = Path("task0_dataset/data_bonus")
SUBDIR_CAPTCHA = "captcha"
SUBDIR_CLEAN   = "clean"

# Lengths of CAPTCHA strings to generate
LENGTHS: Sequence[int] = range(3, 7)  # 3 to 6 => 4 variants
# Images 
TRAIN_IMAGES = 5_000
    ...
    *,
    ...
    for length in sorted(LENGTHS):
        ...
        for cls in tqdm(new_cls, desc=pbar_desc, unit="cls"):
            ...
            # bonus
            elif output_mode == "bonus":
                bonus_dir = ROOT / split_name 
                green_dir = bonus_dir / "green"
                red_dir = bonus_dir / "red"
            ...
            for idx in range(IMAGES_PER_CLASS):
                ...
                # CAPTCHA (bonus i.e. red/green bg)
                elif difficulty == "bonus":
                    ...
                    if random.random() < 0.5:
                        ...
                        bg_color = (r, g, b)
                        cpath = red_dir / fname
                    # write depending on green or red
                    bonus.write(cls, str(cpath), bg_color=bg_color)    
                    
                # Always write a clean version
                if output_mode != "bonus":
